...
Commands:
  ...
  remove-field    Remove the first occurrence of a field from a Main form
  ...
  remove-subgrid  Remove a sub-grid from a Main form by label
```
...
Options:
  ...
  --form <form>                        [Required] Form name
  --section <section>                  [Required] Section label to add the field(s) to
...
Options:
  --entity <entity>                    [Required] Entity logical name
  --form <form>                        [Required] Form name
  --tab <tab>                          [Required] Parent tab label
...
Options:
  --entity <entity>                    [Required] Entity logical name
  --form <form>                        [Required] Form name
  --section <section>                  [Required] Section label to add the sub-grid to
...
Options:
  --entity <entity>                    [Required] Entity logical name
  --form <form>                        [Required] Form name
  --label <label>                      [Required] Section label to search for
  -p, --profile <profile>              Authentication profile name
  -env, --environment <environment>    Override the environment URL. Takes precedence over profile's bound environment.
  -q, --quiet                          Show only warnings and errors
  -v, --verbose                        Show detailed output including debug messages
...
Options:
  --entity <entity>                    [Required] Entity logical name
  --form <form>                        [Required] Form name
  --label <label>                      [Required] Label of the tab to find
  -p, --profile <profile>              Authentication profile name
  -env, --environment <environment>    Override the environment URL. Takes precedence over profile's bound environment.
  -q, --quiet                          Show only warnings and errors
  -v, --verbose                        Show detailed output including debug messages
...
Options:
  ...
  --form <form>                        [Required] Name of the form
  -p, --profile <profile>              Authentication profile name
  -env, --environment <environment>    Override the environment URL. Takes precedence over profile's bound environment.
  -q, --quiet                          Show only warnings and errors
  -v, --verbose                        Show detailed output including debug messages
...
Options:
  --entity <entity>                    [Required] Entity logical name
  --form <form>                        [Required] Form name
  --section <section>                  [Required] Section label
...
Options:
  --entity <entity>                    [Required] Entity logical name
  --form <form>                        [Required] Form name
  --label <label>                      [Required] Label of the sub-grid to remove
  --publish                            Publish customizations after writing
  --solution <solution>                Solution unique name to associate the change with
  -p, --profile <profile>              Authentication profile name
  -env, --environment <environment>    Override the environment URL. Takes precedence over profile's bound environment.
...
Options:
  --entity <entity>                    [Required] Entity logical name
  --form <form>                        [Required] Form name
  --tab <tab>                          [Required] Label of the tab to remove
  --publish                            Publish customizations after writing
  --solution <solution>                Solution unique name to associate the change with
  -p, --profile <profile>              Authentication profile name
  -env, --environment <environment>    Override the environment URL. Takes precedence over profile's bound environment.
...
Options:
  --entity <entity>                    [Required] Entity logical name
  --form <form>                        [Required] Form name
  --section <section>                  [Required] Section label containing the fields to reorder
...
Options:
  --entity <entity>                    [Required] Entity logical name
  --form <form>                        [Required] Form name
  --section <section>                  [Required] Section current label
...
Options:
  --entity <entity>                    [Required] Entity logical name
  --form <form>                        [Required] Form name
  --tab <tab>                          [Required] Current label of the tab to update
